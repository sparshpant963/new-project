        ...
        <div class="container">
          <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
              ...
              <li class="active"> <a href="#Name of User">Hello <span>  <?php echo $_SESSION['admin_name']?></span></a></li>
                <li class="active"><a href="#banner">Home</a></li>
                <li class=""><a href="#service">Services</a></li>
                <li class=""><a href="#about">About</a></li>
                <li class=""><a href="faq.php">People Reviews</a></li>
                <li class=""><a href="#contact">Contact</a></li>
                <li class=""><a href="info.php">Patient Info</a></li>
