...
if(isset($_POST['submit'])){
  ...
  $message = mysqli_real_escape_string($conn, $_POST['message']);
          ...
          $insert = "INSERT INTO review_db(name,email,subjet,message) VALUES('$name','$email','$subject','$message')";
        ...
        <div class="container">
          <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
              ...
              <li class="active"> <a href="">Hello <span>  <?php echo $_SESSION['user_name']?></span></a></li>
                <li class="active"><a href="#banner">Home</a></li>
                <li class=""><a href="#service">Services</a></li>
                <li class=""><a href="#about">About</a></li>
                <li class=""><a href="#contact">Write A Review</a></li>
                <li class=""><a href="patient.php">Want To admit?</a></li>
                <li class=""><a href="history.php">Previous Appointments</a></li>
        ...
        <div class="row">
          <div class="banner-info">
            <!-- <div class="banner-logo text-center">
              <img src="img/1.png" class="img-responsive" style="width: 140px;">
            </div> -->
    ...
    <div class="container">
      <div class=" row">
        ...
        <div class="text-right-md col-md-4 col-sm-4">
          <h2 class="section-title white lg-line">« A few words<br> about Hospital»</h2>
        </div>
        <div class="col-md-4 col-sm-5">
         This Organization was established by Dr. Kumar Anand to provide good medical support and services to people at reasonable rate.The main motive is that we want disease free India.Our plan is to open some more hospital and reach every village of India.
          <p class="text-right text-primary"><i>Dr. Kumar Anand<br>Director,Sony Child Care</i></p>
        </div>
        <div class="col-md-2"></div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <h3>Contact Info</h3>
          <div class="space"></div>
          <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>Benta chowk Darbhanga<br>Bihar</p>
          <!-- <div class="space"></div>
          <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>Arogya123@gmail.com</p> -->
          <div class="space"></div>
          <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+91 7762086307</p>
        </div>
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            <h3 class="cnt-ttl">Having Any Query! Or Have a Complaint Drop us a message.</h3>
            <div class="space"></div>
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" class="contactForm">
              ...
              <div class="form-action">
                <button type="submit" class="btn btn-form" name="submit">Send Message </button>
              </div>
            </form>
          </div>
        </div>
              ...
              <div class="w3-row-padding">
                <div class="w3-third">
                  <div class="social-buttons">        
                            ...
                            <!-- LinkedIn Button
                            <a href="https://www.linkedin.com/mwlite/in/sparsh-mandap-701b661ba" class="social-margin" target="blank">
                              <div class="social-icon linkedin">
                                <i class="fa fa-linkedin" aria-hidden="true"></i>
                              </div> 
                            </a>
                            instagram Button
                            <a href="https://instagram.com/sparssshhhh?igshid=ZDdkNTZiNTM=" target="blank"  class="social-margin">
                              <div class="social-icon instagram">
                                <i class="fa fa-instagram" aria-hidden="true"></i>
                              </div>
                            </a>
                          // Github Button -->
                            <!-- <a href="https://github.com/sparsh10062002"  target="blank"  class="social-margin">
